...
const Header = () => {
    ...
    return (
        <div className={`fixed top-0 left-0 w-full z-50 border-b border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm ${openNavigation ? 'bg-n-8' : 'bg-n/90 backdrop-blur-sm'}`}>
            <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
                ...
                <a href="#sign-up" className="button hidden mr-8 text-n1/50 transition-colors hover:text-n-1 lg:block">New Account</a>
