        ...
        <Section crosses>
            <div className="container lg:flex">
                ...
                <div className="lg:ml-auto mt-4 xl:w-[38rem]">
                    <p className='body-2 mb-12  text-n-4 md:mb-16 lg:mb-32 lg:w-[22rem]'>{collabText}</p>
                    ...
                    <ul >
                        {collabApps.map((item , index) =>(
                            <li key={item.id} className={`absolute top-0 left-1/2 h-1/2 -ml-[1.6rem] origin-bottom rotate-${index * 45}`}>
                                <div className={`relative p-2 -top-[1.6rem] flex w-[3.2rem] bg-n-7 border border-n-1/15 rounded-xl -rotate-${index * 45}`}>
